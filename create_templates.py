...
for template_data in templates_data:
    ...
    print(f'{"Created" if created else "Found"} template: {template.category}')

print(f'Total templates created/found: {AIResponseTemplate.objects.count()}')
