...
try:
    from user.admin_auth import admin_site
except ImportError:
...
urlpatterns = [
    ...
    path('api/api/admin/', include('user.admin_urls')),
    ...
    path('api/admin/', include('user.admin_urls')),
    path('api/admin/orders/', include('order.urls')),  # Admin order management
    
    # Frontend compatibility - redirect /api/user/admin/ to /api/admin/
    path('api/user/admin/', include('user.admin_urls')),
    
    # Frontend compatibility - redirect /admin/ to /api/admin/
