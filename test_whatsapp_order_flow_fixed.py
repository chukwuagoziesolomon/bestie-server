#!/usr/bin/env python3
"""
Test WhatsApp Order Flow with JWT Cart - Fixed Version
"""
import os
import sys
import django
...
def test_whatsapp_order_flow():
    ...
    # Create a mock order for testing with correct parameters
    ...
    try:
        summary_result = ai_service._calculate_and_show_order_summary(test_order, user, context)
